...
def test_cards():
    ...
    c1 = CardEmail("titulo do card 1", descricao, url_image, path_url)
    c2 = CardEmail("titulo do card 2", descricao, url_image, path_url)
    c3 = CardEmail("titulo do card 3", descricao, url_image, path_url)
